...
var CoinextWebSocket = /** @class */ (function () {
    function CoinextWebSocket(isTestEnvironment) {
        ...
        this.subscribeToEvent = function (apiServiceName, apiEventName, callback, payload) {
            return new Promise(function (resolve, reject) {
                _this.callExternalApi(apiServiceName, payload)
                    ...
                    var _a;
                    var listener = function (reply) {
                        var _a = JSON.parse(reply), responseType = _a.m, responseFunction = _a.n, response = _a.o;
                        if (responseType === types_1.SocketOperation.Event && responseFunction === apiEventName) {
        ...
        this.unsubscribeToEvent = function (apiUnsubscribeServiceName, apiEventName, payload) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
