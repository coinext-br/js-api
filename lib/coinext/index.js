...
var Coinext = /** @class */ (function () {
    function Coinext() {
        ...
        this.products = [];
        this.instruments = [];
        this.connect = function (isTestEnvironment) {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, new Promise(function (resolve, reject) {
                                var server = new coinext_ws_1.default(isTestEnvironment);
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, ((_b = this.socket) === null || _b === void 0 ? void 0 : _b.callExternalApi("GetProducts", { OMSId: this.omsId, Depth: 250, }))];
                    case 2:
        ...
        this.getTickerHistory = function (coin, quoteCoin, intervalInSeconds, fromDate, toDate) { return __awaiter(_this, void 0, void 0, function () {
            var instrument, _a, response, errorMessage;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        instrument = this.instrumentForCoin(coin, quoteCoin);
        ...
        this.subscribeToTicker = function (instrumentId, secondsBetweenData, lengthOfTickerHistory, callback) { return __awaiter(_this, void 0, void 0, function () {
            var payload, subscriptionResponse, e_10;
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, ((_a = this.socket) === null || _a === void 0 ? void 0 : _a.subscribeToEvent("SubscribeTicker", "TickerDataUpdateEvent", callback, payload))];
                    case 1:
                        subscriptionResponse = _b.sent();
                        if (subscriptionResponse) {
                            callback(subscriptionResponse.firstPayload);
                            return [2 /*return*/, subscriptionResponse.dispose];
                        }
                        throw new Error("Invalid first response received from SubscribeTicker endpoint");
                    case 2:
                        e_10 = _b.sent();
                        console.warn("Exception captured while subscribing to ticker with instrumentId ".concat(instrumentId, ". Subscription was not fulfilled."));
                        throw e_10;
                    case 3: return [2 /*return*/];
                }
            });
        }); };
        this.unsubscribeToTicker = function (instrumentId) { return __awaiter(_this, void 0, void 0, function () {
            var payload, response, e_11;
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, ((_a = this.socket) === null || _a === void 0 ? void 0 : _a.callExternalApi("UnsubscribeTicker", payload))];
                    case 1:
                        response = _b.sent();
                        return [2 /*return*/, response];
                    case 2:
                        e_11 = _b.sent();
                        console.warn("Exception captured while unsubscribing to ticker with instrumentId ".concat(instrumentId, ". Unsubscription was not fulfilled."));
                        throw e_11;
                    case 3: return [2 /*return*/];
                }
            });
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        e_12 = _b.sent();
                        console.error(e_12);
                        return [2 /*return*/, { errorMessage: "".concat(e_12) }];
                    case 3: return [2 /*return*/];
                }
            });
        });
    };
    Coinext.prototype.instrumentForCoin = function (coin, quoteCoin) {
        var p1 = coin.toUpperCase();
        var p2 = quoteCoin.toUpperCase();
        return this.getInstruments().find(function (i) { return i.Product1Symbol === p1 && i.Product2Symbol === p2; });
    };
    return Coinext;
}());
